            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="panel panel-default">
                        ...
                        <form id="defaultForm" method="post" class="form-horizontal ls_form" action="{{url('admin/products/'.$id)}}"
                                ...
                                <div class="form-group">
                                    <label class="col-lg-3 control-label">منتج بالعربيه</label>
                                    <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                        <label class="col-lg-3 control-label">منتج بالانجليزي</label>
                                        <div class="col-lg-6">
