            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="panel panel-default">
                        ...
                        <form id="defaultForm" method="post" class="form-horizontal ls_form" action="{{url('admin/prefs')}}"
                                ...
                                <div class="form-group">
                                        <label class="col-lg-3 control-label">العنوان الرئيسي </label>
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" name="arMainAddress"
                                                data-bv-message="The username is not valid"
                                                required data-bv-notempty-message="The username is required and cannot be empty"
                                                value="{{old('arMainAddress')}}"
                                                    />
                                        </div>
                                </div>
                                <div class="form-group">
