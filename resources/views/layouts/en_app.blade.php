	...
	<body>
		...
		<nav id="mainNav" class="navbar navbar-default navbar-fixed-top"  data-spy="affix" data-offset-top="100">
          ...
          <li><a  
            ...
            class="page-scroll"
            @endif
            href="{{url('en_services')}}">Services </a></li>
					<li><a @if($title == 'شركة كيان - الاسعار اليوميه')
            class="page-scroll active"
            @else
            class="page-scroll"
            @endif
           href="{{url('en_daily_price')}}">Daily Price</a></li>
          ...
          <li><a 
            ...
            class="page-scroll"
            @endif
             href="{{url('en_about')}}">AboutUs</a></li>
            ...
            class="page-scroll"
            @endif
             href="{{url('en_join_us')}}">JoinUs</a></li>
            ...
            class="page-scroll"
            @endif
             href="{{url('en_contact')}}">ContactUs</a></li>
					...
					<li>
						<div class="dropdown">
						  ...
						  <ul class="dropdown-menu"> 
						    <li><a href="change_language">Arabic</a></li>
						    <li><a href="change_language">English</a></li>
						  </ul>
						</div>
					</li>
			     </ul>
