			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-4 item wow fadeIn" data-wow-duration="2s" >
						<img src="images/location-icon.png" class="pull-left" alt="location">
						<div class="content">
					...
					<div class="col-sm-4 item wow fadeIn" data-wow-duration="2s" data-wow-delay="0.5s">
						<img src="images/phone-icon.png" class="pull-left" alt="phone-icon">
						<div class="content">
					...
					<div class="col-sm-4 item wow fadeIn" data-wow-duration="2s" data-wow-delay="1s">
						<img src="images/email-icon.png" class="pull-left" alt="email-icon">
						<div class="content">
