			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-4 item wow fadeIn" data-wow-duration="2s" >
						<img src="images/location-icon.png" class="pull-right" alt="location">
						<div class="content">
					...
					<div class="col-sm-4 item wow fadeIn" data-wow-duration="2s" data-wow-delay="0.5s">
						<img src="images/phone-icon.png" class="pull-right" alt="phone-icon">
						<div class="content">
					...
					<div class="col-sm-4 item wow fadeIn" data-wow-duration="2s" data-wow-delay="1s">
						<img src="images/email-icon.png" class="pull-right" alt="email-icon">
						<div class="content">
                    ...
                    <form class="contact-form-area" method="post" action="/contact">
                        <div class="row"> 
                            <div class="form-group col-md-12">
                                <input type="text" name="Name" class="form-control" placeholder="الاسم" id="form-name" required>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="row"> 
                                <div class="form-group col-md-6">
                                    <input type="text" name="phone" class="form-control" placeholder="التليفون" id="form-phone" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <input type="text" name="email" class="form-control" placeholder="الايميل" id="form-email" required>
                                </div>
                            </div>
                            
                        </div>
                        <div class="col-sm-12">
                            <textarea rows="8" placeholder="اترك رسالتك" class="form-control" id="form-msg" name="message" required></textarea>
